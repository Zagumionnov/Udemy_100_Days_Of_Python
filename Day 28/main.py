...
pomodoro = tkinter.Label(text="Pomodoro", font=(FONT_NAME, 35, "bold"), bg=YELLOW, fg=GREEN)
pomodoro.grid(column=1, row=0)

checkmarks = tkinter.Label(font=(FONT_NAME, 20, "bold"), bg=YELLOW, fg=GREEN)
